...
import CalculatorButtonView from "./calculator-button-view";
const fs = require("fs");
...
export default class CalculatorView{
	...
	constructor(serializedState) {
		...
		this.element.appendChild(calcdisplay);
		
		// find the output display 
		var display = this.calcdisplay.find("input"); // calculator.find('input');
		console.log(display);
		display.val = '';
		
		var memory = 0;
		
		// testing initialize of buttons
		this.init();
	...
	init() {
		...
		return this.calculator.find("calc-button").each(function(){
			var el,i;
			console.log(el);
			console.log(i);
		})
